...
class FormularioArticulos:
    ...
    def carga_articulos(self):
        ...
        self.label2=ttk.Label(self.labelframe1, text="Articulo:")
        ...
        self.label4=ttk.Label(self.labelframe1, text="Categoria:")
        self.label4.grid(column=0, row=6, padx=4, pady=4)
        self.categoriacarga=tk.StringVar()
        self.entrycategoria=ttk.Entry(self.labelframe1, textvariable=self.categoriacarga)
        self.entrycategoria.grid(column=1, row=6, padx=4, pady=4)

        self.boton1=ttk.Button(self.labelframe1, text="Confirmar", command=self.agregar)
        self.boton1.grid(column=1, row=8, padx=4, pady=4)

    def agregar(self):
        datos=(self.codigocarga.get(),self.descripcioncarga.get(), self.preciocarga.get(), self.categoriacarga.get())
        self.articulo1.alta(datos)
        mb.showinfo("Información", "Los datos fueron cargados")
        self.codigocarga.set("")
        self.descripcioncarga.set("")
        self.preciocarga.set("")
        self.categoriacarga.set("")
